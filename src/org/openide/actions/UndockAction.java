...
*
* @see org.openide.windows.TopComponent#SINGLE
...
public class UndockAction extends CallbackSystemAction {
    ...
    */
    public String getName() {
        return ActionConstants.BUNDLE.getString("UndockWindow");
    }
 ...
 *       help->DEFAULT_HELP
 *  5    Gandalf   1.4         3/30/99  David Simonek   undock, prev, next 
 *       actions now work and activates correctly
