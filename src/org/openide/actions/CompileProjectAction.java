...
public class CompileProjectAction extends ProjectSensitiveAction {
    ...
    */
    public String getName() {
        return NbBundle.getBundle(CompileProjectAction.class).getString("CompileProject");
    }
    ...
    */
    public HelpCtx getHelpCtx() {
        return new HelpCtx (CompileProjectAction.class);
    }
    ...
    */
    protected String iconResource () {
        return "/org/openide/resources/actions/compileProject.gif"; // NOI18N
    }
    ...
    */
    public boolean enable (Node projectDesktop) {
        return projectDesktop.getCookie (CompilerCookie.Compile.class) != null;
    }
