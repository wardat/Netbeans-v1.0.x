...
*
* @see org.openide.debugger.Debugger#traceOver
* @author   Jan Jancura
*/
public class TraceOverAction extends CallbackSystemAction {
    ...
    public String getName() {
        return ActionConstants.BUNDLE.getString("TraceOver");
    }

    /* @return the action's help context */
    public HelpCtx getHelpCtx() {
        return new HelpCtx (TraceOverAction.class);
    }
    ...
    */
    protected String iconResource () {
        return "/org/openide/resources/actions/traceOver.gif"; // NOI18N
    }
