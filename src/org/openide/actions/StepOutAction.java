...
*
* @see org.openide.debugger.Debugger#stepOut
* @author   Jan Jancura
*/
public class StepOutAction extends CallbackSystemAction {
    /** generated Serialized Version UID */
    static final long serialVersionUID = 6502402432309375330L;
    ...
    public String getName() {
        return ActionConstants.BUNDLE.getString ("StepOut");
    }

    /* @return the action's help context */
    public HelpCtx getHelpCtx() {
        return new HelpCtx (StepOutAction.class);
    }
    ...
    */
    protected String iconResource () {
        return "/org/openide/resources/actions/stepOut.gif"; // NOI18N
    }
}
 ...
 *  5    Gandalf   1.4         3/11/99  Jan Jancura     
 *  4    Gandalf   1.3         3/9/99   Jan Jancura     Debugger actions updated
