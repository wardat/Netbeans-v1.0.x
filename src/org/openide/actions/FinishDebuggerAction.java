...
*
* @see org.openide.debugger.Debugger#finishDebugger
* @author   Jan Jancura
*/
public class FinishDebuggerAction extends CallbackSystemAction {
    /** generated Serialized Version UID */
    static final long serialVersionUID = 6936486093582699336L;
    ...
    public String getName() {
        return ActionConstants.BUNDLE.getString("FinishDebugger");
    }

    /* @return the action's help context */
    public HelpCtx getHelpCtx() {
        return new HelpCtx (FinishDebuggerAction.class);
    }
    ...
    */
    protected String iconResource () {
        return "/org/openide/resources/actions/finishDebugger.gif"; // NOI18N
    }
