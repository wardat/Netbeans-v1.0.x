...
public final class PrintSettings extends ContextSystemOption {
    ...
    */
    ...
    public HelpCtx getHelpCtx () {
        return new HelpCtx (PrintSettings.class);
    }
    ...
    public Font getHeaderFont() {
        if (headerFont == null) {
            headerFont = Font.decode(getString("DEFAULT_HEADER_FONT"));
        }
        return headerFont;
    }
    ...
    */
    ...
    static String getString(String s) {
        if (bundle == null) {
            bundle = NbBundle.getBundle(PrintSettings.class);
        }
    ...
    public static class AlignmentEditor extends java.beans.PropertyEditorSupport {
        ...
        private String[] tags = new String[] {
                                    sLEFT = getString("CTL_LEFT"),
                                    sCENTER = getString("CTL_CENTER"),
                                    sRIGHT = getString("CTL_RIGHT")};
...
/*
 * Log
 *  11   Gandalf-post-FCS1.9.1.0     4/5/00   Miloslav Metelka default header font now 
 *       in bundle
 *  10   Gandalf   1.9         3/7/00   Miloslav Metelka super's called in 
 *       read/writeExternal() to (de)serialize child options.
 *  9    Gandalf   1.8         1/13/00  Ian Formanek    NOI18N
 *  8    Gandalf   1.7         10/22/99 Ian Formanek    NO SEMANTIC CHANGE - Sun
 *       Microsystems Copyright in File Comment
 *  7    Gandalf   1.6         7/2/99   Jesse Glick     More help IDs.
 *  6    Gandalf   1.5         6/8/99   Ian Formanek    ---- Package Change To 
 *       org.openide ----
 *  5    Gandalf   1.4         5/12/99  Ales Novak      0.7 lineAscentCorrection
 *  4    Gandalf   1.3         5/12/99  Ales Novak      NullPointerException 
 *       during serialization
 *  3    Gandalf   1.2         5/11/99  Ales Novak      new option added
 *  2    Gandalf   1.1         4/30/99  Ales Novak      changed to 
 *       ContextSystemOption
