...
public class JCompletion {
    ...
    private static final SimpleClass[] primitiveClasses = new SimpleClass[] {
                BOOLEAN_CLASS,
                BYTE_CLASS,
                CHAR_CLASS,
                DOUBLE_CLASS,
    ...
    private static final BaseType[] primitiveTypes = new BaseType[] {
                BOOLEAN_TYPE,
                BYTE_TYPE,
                CHAR_TYPE,
                DOUBLE_TYPE,
    ...
    /** Get the current default finder */
    public static JCFinder getFinder() {
        return finder;
    }

    /** Set the current default finder */
    public static void setFinder(JCFinder f) {
        finder = f;
    }
    ...
    public static boolean isPrimitiveClassName(String s) {
        return JavaKeywords.isTypeOrVoid(JavaKeywords.getKeyword(s));
    }
    ...
    public static JCClass getPrimitiveClass(String s) {
        int kwd = JavaKeywords.getKeyword(s);
        return (JavaKeywords.isTypeOrVoid(kwd)) ? primitiveClasses[kwd] : null;
    }

    public static JCType getPrimitiveType(String s) {
        int kwd = JavaKeywords.getKeyword(s);
        return (JavaKeywords.isTypeOrVoid(kwd)) ? primitiveTypes[kwd] : null;
    }
    ...
    public static Iterator getPrimitiveClassIterator() {
        return new Iterator() {
                   ...
                   public boolean hasNext() {
                       return (ind < primitiveClasses.length - 1);
                   }

                   public Object next() {
                       return primitiveClasses[ind++];
                   }
    ...
    */
    ...
    public static class SimpleClass implements JCClass {
        ...
        public String toString() {
            return (getPackageName().length() > 0)
