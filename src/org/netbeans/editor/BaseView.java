...
public abstract class BaseView extends View {
    ...
    */
    ...
    public abstract void modelToViewDG(int pos, Drawer.DrawGraphics dg)
    ...
    */
    ...
    /** Get extended UI */
    protected ExtUI getExtUI() {
        return ((BaseTextUI)getComponent().getUI()).getExtUI();
    }
 ...
 *  12   Gandalf   1.11        10/8/99  Miloslav Metelka stability improvements
 *  11   Gandalf   1.10        7/9/99   Miloslav Metelka 
 ...
 *  4    Gandalf   1.3         3/27/99  Miloslav Metelka 
 *  3    Gandalf   1.2         3/18/99  Miloslav Metelka 
 *  2    Gandalf   1.1         2/13/99  Miloslav Metelka 
