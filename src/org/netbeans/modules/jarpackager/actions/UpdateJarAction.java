...
/** Updates content of jar file.
*
* @author   Dafe Simonek
*/
public final class UpdateJarAction extends CompileAction {
    ...
    */
    public String getName() {
        return NbBundle.getBundle(UpdateJarAction.class).
               getString("CTL_UpdateJarAction");
    }
    ...
    */
    public HelpCtx getHelpCtx() {
        return new HelpCtx (UpdateJarAction.class); //PENDING
    }
    ...
    */
    protected String iconResource () {
        return "/org/netbeans/modules/jarpackager/resources/updateJar.gif"; // NOI18N
    }
