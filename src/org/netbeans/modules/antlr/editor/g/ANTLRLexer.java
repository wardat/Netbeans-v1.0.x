...
public class ANTLRLexer extends antlr.CharScanner implements ANTLRTokenTypes, TokenStream
{
    ...
    public ANTLRLexer(LexerSharedInputState state) {
        ...
        literals.put(new ANTLRHashString("TextColor", this), new Integer(4));
...
_loop858:
            do {
                if (((LA(1) >= '0' && LA(1) <= '9'))) {
                    ...
                    if ( _cnt858>=1 ) { break _loop858; } else {throw new ScannerException("no viable alt for char: "+(char)LA(1),getLine());}
                }
