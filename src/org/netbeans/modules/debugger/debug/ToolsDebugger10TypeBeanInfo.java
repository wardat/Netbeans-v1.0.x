...
/** Object that provides beaninfo for {@link ToolsDebugger10Type}.
*
* @author Jan Jancura
*/
public class ToolsDebugger10TypeBeanInfo extends SimpleBeanInfo {
    ...
    static {
        descr = new BeanDescriptor (ToolsDebugger10Type.class);
        ResourceBundle bundle = NbBundle.getBundle (ToolsDebugger10TypeBeanInfo.class);

        descr.setName (bundle.getString ("CTL_ToolsDebugger10TypeName"));

        try {
            prop = new PropertyDescriptor[] {
                       new PropertyDescriptor (ToolsDebugger10Type.PROP_JAVA_HOME, ToolsDebugger10Type.class,
                                               "getJavaHome", "setJavaHome"), // 0 // NOI18N
                   };
            prop[0].setDisplayName (bundle.getString ("PROP_JAVA_HOME_10"));
            prop[0].setShortDescription (bundle.getString ("HINT_JAVA_HOME_10"));
