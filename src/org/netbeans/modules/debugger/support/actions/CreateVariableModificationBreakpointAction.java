...
/**
* CreateVariableModificationBreakpointAction action.
*
* @author   Jan Jancura
*/
public class CreateVariableModificationBreakpointAction extends CookieAction {
    ...
    */
    ...
    public String getName () {
        return NbBundle.getBundle (CreateVariableModificationBreakpointAction.class).getString ("CTL_CreateVariableModificationBreakpoint");
    }

    /** @return the action's help context */
    public HelpCtx getHelpCtx () {
        return new HelpCtx (CreateVariableModificationBreakpointAction.class);
    }
}
