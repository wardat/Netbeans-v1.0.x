...
/**
* Enables all breakpoints in the .
...
public final class EnableAllBreakpointsAction extends CookieAction {
    ...
    */
    ...
    public String getName () {
        return NbBundle.getBundle (EnableAllBreakpointsAction.class).getString ("CTL_EnableAll");
    }

    /** @return the action's help context */
    public HelpCtx getHelpCtx () {
        return new HelpCtx (EnableAllBreakpointsAction.class);
    }
}
