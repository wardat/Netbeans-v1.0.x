...
/**
* Module installation class for TXTModule
*
* @author Ian Formanek
*/
public class TXTModule extends org.openide.modules.ModuleInstall {
    ...
    private void copyTemplates () {
        try {
            org.openide.filesystems.FileUtil.extractJar (
                ...
                NbBundle.getLocalizedFile ("org.netbeans.modules.text.templates", "jar").openStream () // NOI18N
            );
