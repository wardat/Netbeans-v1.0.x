 ...
 * @author Jan Formanek
 */
class ErrorExpressionPanel extends javax.swing.JPanel implements EnhancedCustomPropertyEditor {
    ...
    */
    public ErrorExpressionPanel(ErrorDescriptionsPropertyEditor ed) {
        editor = ed;
        // make a copy of the current value
        descriptions = new ErrorDescriptions ((ErrorDescriptions)editor.getValue ());
        ...
        setBorder (new javax.swing.border.CompoundBorder (
                       ...
                       new javax.swing.border.TitledBorder (
                           new javax.swing.border.EtchedBorder (), CompilerSettings.bundle.getString("CTL_Error_description_name"))));

        addButton.setText(CompilerSettings.bundle.getString("CTL_Add"));
        addButton.setToolTipText(CompilerSettings.bundle.getString("CTL_Add_tip"));
        removeButton.setText(CompilerSettings.bundle.getString("CTL_Remove"));
        removeButton.setToolTipText(CompilerSettings.bundle.getString("CTL_Remove_tip"));
        setButton.setText(CompilerSettings.bundle.getString("CTL_Set"));
        setButton.setToolTipText(CompilerSettings.bundle.getString("CTL_Set_tip"));
        presetNameLabel.setText(CompilerSettings.bundle.getString("CTL_Preset_label"));
        errorDescriptionLabel.setText(CompilerSettings.bundle.getString("CTL_Error_label"));
        filePositionLabel.setText(CompilerSettings.bundle.getString("CTL_File_label"));
        linePositionLabel.setText(CompilerSettings.bundle.getString("CTL_Line_label"));
        columnPositionLabel.setText(CompilerSettings.bundle.getString("CTL_Column_label"));
        descriptionPositionLabel.setText(CompilerSettings.bundle.getString("CTL_Description_label"));
        ...
        ListSelectionListener l = new ListSelectionListener() {
                                      public void valueChanged(ListSelectionEvent ev) {
                                          ...
                                          if (sel < 0) return;
                                          descriptions.setSelectedExpression (descriptions.getExpressions ()[sel]);
                                          updateFields ();
                                          updateButtons ();
                                      }
                                  };
    ...
    */
    ...
    private void updateList () {
        ExternalCompiler.ErrorExpression[] exprs = descriptions.getExpressions ();
        ExternalCompiler.ErrorExpression sel = descriptions.getSelectedExpression ();
    ...
    private void updateFields () {
        ExternalCompiler.ErrorExpression current = descriptions.getSelectedExpression ();
    ...
    private void initComponents () {//GEN-BEGIN:initComponents
        ...
        presetNameLabel.setText ("presetName"); // NOI18N
        ...
        errorDescriptionLabel.setText ("errorDescription"); // NOI18N
        gridBagConstraints2 = new java.awt.GridBagConstraints ();
        gridBagConstraints2.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints2.insets = new java.awt.Insets (2, 2, 2, 2);
        gridBagConstraints2.anchor = java.awt.GridBagConstraints.WEST;
        ...
        filePositionLabel.setText ("filePosition"); // NOI18N
        gridBagConstraints2 = new java.awt.GridBagConstraints ();
        gridBagConstraints2.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints2.insets = new java.awt.Insets (2, 2, 2, 2);
        gridBagConstraints2.anchor = java.awt.GridBagConstraints.WEST;
        ...
        linePositionLabel.setText ("linePosition"); // NOI18N
        gridBagConstraints2 = new java.awt.GridBagConstraints ();
        gridBagConstraints2.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints2.insets = new java.awt.Insets (2, 2, 2, 2);
        gridBagConstraints2.anchor = java.awt.GridBagConstraints.WEST;
        ...
        columnPositionLabel.setText ("columnPosition"); // NOI18N
        gridBagConstraints2 = new java.awt.GridBagConstraints ();
        gridBagConstraints2.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints2.insets = new java.awt.Insets (2, 2, 2, 2);
        gridBagConstraints2.anchor = java.awt.GridBagConstraints.WEST;
        ...
        descriptionPositionLabel.setText ("descriptionPosition"); // NOI18N
        gridBagConstraints2 = new java.awt.GridBagConstraints ();
        gridBagConstraints2.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints2.insets = new java.awt.Insets (2, 2, 2, 2);
        gridBagConstraints2.anchor = java.awt.GridBagConstraints.WEST;
        ...
        removeButton.setText ("Remove"); // NOI18N
        ...
        setButton.setText ("Change"); // NOI18N
    ...
    private void removeButtonActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        internalListChange = true;
        java.util.Vector exprs = descriptions.getExpressionsVector ();
        int pos = errorDescriptions.getSelectedIndex ();
        exprs.removeElementAt (pos);
    ...
    private void setButtonActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setButtonActionPerformed
        if ("".equals (presetNameField.getText ())) // NOI18N
            return;
        ExternalCompiler.ErrorExpression expr = descriptions.getSelectedExpression ();
        int fPos = 0;
        int lPos = 0;
        int cPos = 0;
        int dPos = 0;
    ...
    private void addButtonActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if ("".equals (presetNameField.getText ())) // NOI18N
            return;
        ExternalCompiler.ErrorExpression[] exprsAr = descriptions.getExpressions ();
        ...
        try {
            expr = new ExternalCompiler.ErrorExpression (
        ...
        descriptions.setSelectedExpression (expr);
        pos = exprs.size () - 1;
        updateList ();
        errorDescriptions.setSelectedIndex (pos);
        internalListChange = false;
