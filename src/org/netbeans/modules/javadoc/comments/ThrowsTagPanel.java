...
public class ThrowsTagPanel extends TagPanel {
    ...
    private void initComponents () {//GEN-BEGIN:initComponents
        ...
        gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
        add (exceptionComboBox, gridBagConstraints1);
    ...
    void setData( JavaDocTag tag ) {
        exceptionComboBox.getEditor().setItem( ((JavaDocTag.Throws)tag).exceptionName() );
        descriptionTextArea.setText( ((JavaDocTag.Throws)tag).exceptionComment() );
