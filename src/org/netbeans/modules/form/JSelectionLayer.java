...
* @author   Ian Formanek
*/
final public class JSelectionLayer extends JComponent implements Selection {
    ...
    /** Creates a new JSelectionLayer. */
    public JSelectionLayer (RADVisualComponent radComp, Component comp, Selection.ResizeListener rListener, Selection.MoveListener mListener) {
...
/*
 * Log
 *  3    Gandalf   1.2         12/8/99  Pavel Buzek     4638 fixed
