...
/** FormInfo for javax.swing.JInternalFrame.
*
* @author Ian Formanek
*/
public class JInternalFrameFormInfo extends FormInfo implements JMenuBarContainer {
    ...
    */
    public Object getFormInstance () {
        if (formInstance == null) {
            formInstance = new JInternalFrame ();
        }
        return formInstance;
    }
 ...
 *  6    Gandalf   1.5         7/16/99  Ian Formanek    implements 
 *       JMenuBarContainer
 *  5    Gandalf   1.4         7/4/99   Ian Formanek    Fixed problem with 
 *       adding to JInternalFrame
 *  4    Gandalf   1.3         6/6/99   Ian Formanek    FormInfo design 
 *       finalized
 *  3    Gandalf   1.2         5/12/99  Ian Formanek    
