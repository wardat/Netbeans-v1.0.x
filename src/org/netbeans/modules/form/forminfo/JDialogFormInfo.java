...
/** FormInfo for javax.swing.JDialog.
*
* @author Ian Formanek
*/
public class JDialogFormInfo extends FormInfo implements JMenuBarContainer {
    ...
    */
    public Object getFormInstance () {
        if (formInstance == null) {
            formInstance = new JDialog (org.openide.TopManager.getDefault().getWindowManager().getMainWindow ());
        }
        return formInstance;
    }
 ...
 *  4    Gandalf   1.3         7/16/99  Ian Formanek    implements 
 *       JMenuBarContainer
