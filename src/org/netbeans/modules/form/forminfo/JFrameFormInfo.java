...
/** FormInfo for javax.swing.JFrame.
*
* @author Ian Formanek
*/
    ...
    */
    public Object getFormInstance () {
        if (formInstance == null) {
            formInstance = new JFrame ();
        }
        return formInstance;
    }

    /** Used to provide the container which is used during design-time as the top-level component.
 ...
 *  7    Gandalf   1.6         7/16/99  Ian Formanek    implements 
 *       JMenuBarContainer
 *  6    Gandalf   1.5         7/9/99   Ian Formanek    Menu editor improvements
 *  5    Gandalf   1.4         7/5/99   Ian Formanek    implements 
 *       JMenuBarContainer
