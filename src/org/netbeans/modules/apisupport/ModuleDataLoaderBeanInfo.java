...
public class ModuleDataLoaderBeanInfo extends SimpleBeanInfo {

    public BeanInfo[] getAdditionalBeanInfo () {
        try {
            return new BeanInfo[] { Introspector.getBeanInfo (JarDataLoader.class) };
...
/*
 * Log
 *  8    Gandalf   1.7         1/22/00  Jesse Glick     
