...
/** Servlet for handling NetBeans repository requests
*
* @author Petr Jiricka
...
public class RepositoryServlet extends NbBaseServlet {
    ...
    */
    public String getServletInfo() {
        return NbBundle.getBundle(RepositoryServlet.class).getString("MSG_RepositoryServletDescr");
    }
 ...
 *  5    Gandalf   1.4         1/11/00  Petr Jiricka    Debug output removed
