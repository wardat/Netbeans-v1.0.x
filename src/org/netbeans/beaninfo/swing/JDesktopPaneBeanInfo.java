...
* @author  Ian Formanek
*/
public class JDesktopPaneBeanInfo extends java.beans.SimpleBeanInfo {
    /** Icons */
    ...
    public Image getIcon (int type) {
        if (icon == null) {
            icon = loadImage("/org/netbeans/beaninfo/swing/JDesktopPane.gif"); // NOI18N
            icon32 = loadImage ("/org/netbeans/beaninfo/swing/JDesktopPane32.gif"); // NOI18N
        }
