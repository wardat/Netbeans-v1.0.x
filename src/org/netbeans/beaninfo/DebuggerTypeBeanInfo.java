...
public class DebuggerTypeBeanInfo extends SimpleBeanInfo {
    ...
    static {
        descr = new BeanDescriptor (org.openide.debugger.DebuggerType.class);
        ResourceBundle bundle = NbBundle.getBundle(DebuggerTypeBeanInfo.class);
        descr.setDisplayName (bundle.getString ("LAB_DebuggerType"));
        descr.setShortDescription (bundle.getString ("HINT_DebuggerType"));
    ...
    public Image getIcon(int type) {
        if (icon == null) {
            icon = loadImage("/org/netbeans/core/resources/debuggerTypes.gif"); // NOI18N
            icon32 = loadImage("/org/netbeans/core/resources/debuggerTypes32.gif"); // NOI18N
        }
