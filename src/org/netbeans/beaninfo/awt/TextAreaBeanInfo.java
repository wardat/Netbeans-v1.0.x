...
*/
public class TextAreaBeanInfo extends TextComponentBeanInfo {
    ...
    public TextAreaBeanInfo() {
        if (icon == null) {
            icon = loadImage("/org/netbeans/beaninfo/awt/textarea.gif"); // NOI18N
            icon32 = icon;
        }
    }
    ...
    */
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        if (desc == null) {
            synchronized (TextAreaBeanInfo.class) {
                if (desc == null) {
                    ...
                    try {
                        desc[inh.length] = new PropertyDescriptor("rows", java.awt.TextArea.class); // NOI18N
                        desc[inh.length + 1] = new PropertyDescriptor("columns", java.awt.TextArea.class); // NOI18N
