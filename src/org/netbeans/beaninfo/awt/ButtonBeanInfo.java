...
*/
public class ButtonBeanInfo extends ComponentBeanInfo {
    ...
    public ButtonBeanInfo() {
        if (icon == null) {
            icon = loadImage("/org/netbeans/beaninfo/awt/button.gif"); // NOI18N
            icon32 = icon;
        }
    }
    ...
    */
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        if (desc == null) {
            synchronized (ButtonBeanInfo.class) {
                if (desc == null) {
                    ...
                    try {
                        desc[inh.length] = new PropertyDescriptor("actionCommand", java.awt.Button.class); // NOI18N
                        desc[inh.length + 1] = new PropertyDescriptor("label", java.awt.Button.class); // NOI18N
