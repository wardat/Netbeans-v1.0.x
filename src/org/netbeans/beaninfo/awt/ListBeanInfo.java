...
*/
public class ListBeanInfo extends ComponentBeanInfo {
    ...
    public ListBeanInfo() {
        if (icon == null) {
            icon = loadImage("/org/netbeans/beaninfo/awt/list.gif"); // NOI18N
            icon32 = icon;
        }
    }
    ...
    */
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        if (desc == null) {
            synchronized (ListBeanInfo.class) {
                if (desc == null) {
                    ...
                    try {
                        desc[inh.length] = new PropertyDescriptor("multipleMode", java.awt.List.class); // NOI18N
